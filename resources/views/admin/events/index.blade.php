...
<div class="flex min-h-screen bg-gray-50">
    ...
    <div class="sidebar-container bg-[#1B4B5A] text-white flex flex-col">
        ...
        <nav class="mt-8 flex-1">
            <a href="/dashboard" class="flex items-center px-4 py-3 hover:bg-[#2C5F6E] transition-colors {{ request()->is('dashboard') ? 'bg-[#2C5F6E]' : '' }} mb-2">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                </svg>
                Dashboard
            </a>
            <a href="/users" class="flex items-center px-4 py-3 hover:bg-[#2C5F6E] transition-colors {{ request()->is('users*') ? 'bg-[#2C5F6E]' : '' }} mb-2">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('admin.volunteers.index') }}" class="flex items-center px-4 py-3 hover:bg-[#2C5F6E] transition-colors {{ request()->routeIs('admin.volunteers.index') ? 'bg-[#2C5F6E]' : '' }} mb-2">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
