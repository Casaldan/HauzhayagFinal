    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <div class="w-64 bg-[#1B4B5A] text-white flex flex-col fixed h-full">
            ...
            <nav class="mt-8 flex-1 flex flex-col">
                ...
                <a href="{{ route('admin.volunteers.index') }}" class="flex items-center px-4 py-3 hover:bg-[#2C5F6E] transition-colors {{ request()->routeIs('admin.volunteers.index') ? 'bg-[#2C5F6E]' : '' }}">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-1 p-6 bg-gray-50 ml-64 overflow-y-auto h-screen">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white rounded-lg shadow-sm p-4 border-l-4 border-orange-500">
                    <div class="flex justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-500">Pending Applicants</p>
                            <p class="text-xl font-bold text-gray-800 mt-1">
                        ...
                        <div class="rounded-full bg-orange-100 p-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v5a2 2 0 01-2 2H5a2 2 0 01-2-2v-5a2 2 0 012-2m14 0V9a2 2 0 00-2-2H7a2 2 0 00-2 2v2m7 7h.01" />
                            </svg>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-white rounded-lg shadow overflow-hidden mt-6">
                <div class="p-4 bg-gray-50 border-b border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">Pending Scholarship Applications</h3>
                </div>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse($pendingApplications as $application)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ $application->tracking_code }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ ucfirst($application->scholarship_type) }}</td>
                                    <td class="px-6 py-4 whitespace-nowrap text-left text-sm font-medium">
                                        <a href="{{ route('admin.applications.show', $application->tracking_code) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">View</a>
                                        <a href="{{ route('admin.students.approve', $application->tracking_code) }}" class="text-green-600 hover:text-green-900 mr-3">Approve</a>
                                        <a href="{{ route('admin.students.reject', $application->tracking_code) }}" class="text-red-600 hover:text-red-900">Reject</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">No pending applications found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
