<x-app-layout>
    <div class="flex">
        ...
        <div class="w-64 h-screen bg-[#1B4B5A] text-white flex flex-col fixed">
        ...
        <!-- Main Content -->
        <div class="flex-1 p-8 bg-gray-50 ml-64 overflow-y-auto">
            ...
            @endif
            <form action="{{ route('jobs.store') }}" method="POST" class="bg-white rounded-lg shadow-md p-8 max-w-3xl mx-auto">
                @csrf
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="category" class="w-full border border-gray-300 rounded px-3 py-2" required value="{{ old('category') }}">
                </div>

                <div class="flex justify-end">
                    <button type="submit" class="bg-secondary text-black px-6 py-2 rounded hover:bg-secondary/80 transition">Add Job</button>
                </div>
            </form>
        </div>
    </div>
