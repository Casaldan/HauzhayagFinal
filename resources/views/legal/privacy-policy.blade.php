            ...
            <div class="space-y-6 text-gray-700 leading-relaxed">
                ...
                <div>
                    ...
                    <ul class="list-disc list-inside space-y-2 ml-4">
                        ...
                        <li>Communicate with applicants and volunteers about programs and opportunities</li>
                        <li>Verify eligibility and conduct background checks when necessary</li>
                ...
                <div>
                    ...
                    <ul class="list-disc list-inside space-y-2 ml-4">
                        ...
                        <li><strong>Partner Organizations:</strong> Educational institutions or community partners (with consent)</li>
                    </ul>
                </div>
