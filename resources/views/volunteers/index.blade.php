...
<div class="flex h-screen">
        <div class="w-64 bg-[#1B4B5A] text-white overflow-y-auto">
            ...
            <nav class="mt-8">
                <a href="/dashboard" class="flex items-center px-4 py-3 hover:bg-white/10 transition-colors">
                ...
                <a href="/jobs" class="flex items-center px-4 py-3 hover:bg-white/10 transition-colors">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
