    ...
    <div class="flex">
        ...
        <div class="w-64 min-h-screen bg-[#1B4B5A] text-white flex flex-col">
            ...
            <nav class="mt-8 flex-1 flex flex-col">
                <a href="{{ route('student.dashboard') }}" class="flex items-center px-4 py-3 hover:bg-[#2C5F6E] transition-colors {{ request()->routeIs('student.dashboard') ? 'bg-[#2C5F6E]' : '' }}">
                ...
                <a href="{{ route('student.events.index') }}" class="flex items-center px-4 py-3 hover:bg-[#2C5F6E] transition-colors {{ request()->routeIs('student.events.index') ? 'bg-[#2C5F6E]' : '' }}">
                    <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" 
