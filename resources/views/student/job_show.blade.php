    ...
    <div class="w-full max-w-md mx-auto">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <div class="flex justify-center mt-8">
                 <a href="{{ route('student.job.listings') }}" class="inline-flex items-center px-6 py-2 bg-blue-600 text-white rounded-lg shadow hover:bg-blue-700 transition-colors font-semibold">
