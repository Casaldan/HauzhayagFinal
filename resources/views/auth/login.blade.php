...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-br from-dark to-gray-800 p-4">
    <div class="login-container p-4 lg:p-8 rounded-2xl w-full max-w-md">
        <div class="form-container rounded-xl p-6 lg:p-8">
            <!-- Logo -->
            <div class="flex justify-center mb-4 lg:mb-6">
                <div class="w-20 h-20 lg:w-24 lg:h-24 bg-white/10 rounded-full flex items-center justify-center p-2">
            ...
            <div class="text-center mb-6 lg:mb-8">
                <h2 class="text-xl lg:text-2xl font-bold text-white">Welcome Back</h2>
                <p class="text-gray-400 text-xs lg:text-sm mt-1">Hauz Hayag Portal</p>
            </div>
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4 lg:space-y-6">
                @csrf
                <div>
                    <label for="email" class="block text-xs lg:text-sm font-medium text-gray-300 mb-1">Email</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg class="h-4 w-4 lg:h-5 lg:w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
                                <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"/>
                                <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"/>
                            </svg>
                        </div>
                        <input type="email" id="email" name="email"
                               class="pl-8 lg:pl-10 w-full px-3 lg:px-4 py-2 lg:py-2.5 bg-gray-700 border border-gray-600 rounded-lg text-xs lg:text-sm text-gray-200 placeholder-gray-400 focus:ring-2 focus:ring-primary focus:border-primary"
                ...
                <div>
                    <label for="password" class="block text-xs lg:text-sm font-medium text-gray-300 mb-1">Password</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg class="h-4 w-4 lg:h-5 lg:w-5 text-gray-500" viewBox="0 0 20 20" fill="currentColor">
